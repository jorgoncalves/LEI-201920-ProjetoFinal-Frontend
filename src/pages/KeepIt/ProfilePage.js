    ...
    async function userInform() {
      ...
      setState({
        userInfo_form: {
          ...
          country_code: {
            value: userInfo.country_code && userInfo.phone_number ? `${userInfo.country_code}` : 'NA',
            valid: true,
            touched: false,
            validators: [required],
          },
          phone_number: {
            value: userInfo.country_code && userInfo.phone_number ? `${userInfo.phone_number}` : '',
            valid: true,
            touched: false,
            validators: [required],
          },
  ...
  return (
    ...
    {loading ? (
      ...
      <div className="profileBox">
        ...
        <div className="profileBox">
          ...
          >
            <div className="profileLInline">
              <h4 className="uk-comment-title uk-margin-small-bottom inlineB"><b>Name: </b></h4>
              <Input
                id="name"
                type="text"
                control="input"
              ...
              <h4 className="uk-comment-title uk-margin-small-bottom uk-margin-remove-top inlineB"><b>Email: </b>{userInfo.email}</h4><br/>

              <h4 className="uk-comment-title uk-margin-small-bottom uk-margin-remove-top"><b>Department: </b>{userInfo.department}</h4><br/>

              <h4 className="uk-comment-title uk-margin-small-bottom uk-margin-medium-top inlineB"><b>Country: </b></h4>
              <Input
                id="country"
                type="text"
                control="input"
              ...
              <h4 className="uk-comment-title uk-margin-small-bottom uk-margin-remove-top inlineB"><b>Phone Number: </b></h4>
              <Input
                id="country_code"
                type="number"
                control="input"
        ...
        <h3 className="uk-margin-medium-bottom uk-margin-small-top">User Settings</h3>
        <div className="profileBox">
          <Button onClick={editable.bind(this)} children='Edit Profile'></Button>
        </div>
      </div>
      </>
    )} </>
